...
class WordManager {
    ...
    private(set) var dothrakiWords : [Word] = [
        ...
        Word(word: "Dothraki", answer: "Den ridande"),
        ...
        Word(word: "Jatthirar", answer: "Att skära"),
        Word(word: "Zhor", answer: "Hjärta"),
    ]
    private(set) var valyrianWords : [Word] = [
        
        Word(word: "Dracarys", answer: "Eld"),
        Word(word: "Valar Morghulis", answer: "Alla människor måste dö"),
        Word(word: "Valar Dohaeris", answer: "Alla människor måste tjäna"),
        Word(word: "Khaleesi", answer: "Drottning"),
        Word(word: "Khal", answer: "Ledare"),
        Word(word: "Targaryen", answer: "Familjen Targaryen"),
